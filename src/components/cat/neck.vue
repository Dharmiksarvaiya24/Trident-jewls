<template>
    <div class="min-h-screen bg-gray-100 py-6 sm:py-8 lg:py-12">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-center text-gray-900 mb-8 sm:mb-12">Our Necklace Products</h1>
  ...
  const products = ref([
    {
      id: 1,
      name: "Gold Necklace",
      description: "Elegant gold necklace for all occasions.",
      price: 2499,
      image: "https://i.ibb.co/8nPFTc56/Screenshot-from-2025-01-31-14-50-03.png"
    },
    {
      id: 2,
      name: "Silver Pendant",
      description: "Sleek silver pendant necklace.",
      price: 1799,
      image: "https://i.ibb.co/BKKWmQLy/Screenshot-from-2025-01-31-14-51-28.png"
    },
    {
      id: 3,
      name: "Diamond Necklace",
      description: "Luxurious diamond necklace with stunning brilliance.",
      price: 7999,
      image: "https://i.ibb.co/4nHTGDz3/Screenshot-from-2025-01-31-14-52-21.png"
    },
    {
      id: 4,
      name: "Pearl Necklace",
      description: "Timeless pearl necklace for a sophisticated look.",
      price: 3999,
      image: "https://i.ibb.co/s9nd8frk/Screenshot-from-2025-01-31-14-52-56.png"
    },
    {
      id: 5,
      name: "Choker Necklace",
      description: "Trendy choker necklace for modern styles.",
      price: 9999,
      image: "https://i.ibb.co/3JDktmF/Screenshot-from-2025-01-31-14-53-30.png"
    },
    {
      id: 6,
      name: "Beaded Necklace",
      description: "Colorful beaded necklace for a casual look.",
      price: 4999,
      image: "https://i.ibb.co/ZpnrkrHb/Screenshot-from-2025-01-31-14-54-00.png"
    }
  ])
